...
export default {
  async up(queryInterface: QueryInterface) {
    ...
    const demoMovies = [
      {
        ...
        synopsis: 'Película demo creada por el seeder para poblar dependencias.',
    ...
    await queryInterface.bulkInsert('movies', demoMovies, { ignoreDuplicates: true } as any);
  },

  async down(queryInterface: QueryInterface) {
    await queryInterface.bulkDelete('movies', {
      title: ['Demo Movie 1', 'Demo Movie 2']
    } as any, {});
  },
};
